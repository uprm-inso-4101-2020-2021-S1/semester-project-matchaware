...
class UserDAO:
   ...
   ##     self.conn = connection_url
    ...
    def __init__(self):
        #connection_url = pymysql.connect(host='24.54.205.36', user='RemoteMatcha', passwd='RemoteMatcha',
        #                                 db='BeyondHorizonsDB', port=6606)
        connection_url = pymysql.connect(host="localhost", user='Argent', passwd='ArgentSable776', db='BeyondHorizonsDB')
